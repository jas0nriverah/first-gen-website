        ...
        <div className="flex h-14 items-center justify-between sm:h-16">
          ...
          <div className="flex items-center gap-2">
            <nav className="hidden items-center gap-0.5 lg:flex" aria-label="Main navigation">
              ...
              <Link
                href={altLocaleHref}
                className="ml-2 inline-flex items-center gap-1.5 rounded-xl border border-border bg-card px-3 py-1.5 text-xs font-medium text-ink transition-colors hover:border-border-dark"
              >
